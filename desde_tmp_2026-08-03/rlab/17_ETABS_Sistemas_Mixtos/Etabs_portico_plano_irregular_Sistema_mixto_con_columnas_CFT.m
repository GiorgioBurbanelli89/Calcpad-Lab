...
% Datos del material
% Ec=150000*sqrt(210); %Módulo de elasticidad del hormigón T/m2
...
%Geometria_volcar determina datos de geometr�a de un p�rtico
% plano regular para el an�lisis de KL Funci�n Geometr�a volcar
...
%que reporta el programa anterior. Solo sirve para p�rticos regulares, considerando nudo en la mitad de las vigas.
...
% vc Programa que calcula el vector colocaci�n de un p�rtico plano
X
Y
NI
NJ
...
%% Cálculo de la matriz de rigidez del portico A,B,C y D
...
for i = 1:size(ELEM, 1) % Bucle para escoger qu� Inercia y �rea se va a usar en el programa
    if i <= nudcol
